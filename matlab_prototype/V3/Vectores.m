...
%[] = Vectores(b,a)grafica vectores que van desde las ubicaciones
%especificadas en "b" hacia las ubicaciones especificadas en "a"
...
for i=1:6%ciclo for para graficar los 6 vectores
