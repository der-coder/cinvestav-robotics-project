...
Sin embargo para el desarrollo de la PGS la dinámica directa necesita de los valores del jacobiano y su derivada. Pero utilizando la ecuacion \ref{equ:q_twist} en la \ref{equ:twist_loc} se encuentra que:
\begin{equation}
\nu_i = J_i(q) A(d,R) R(R) \nu_p = T_i(d,R) \nu_p
\end{equation}
